...
RfuBot=[lineMID]
Family=["u3ad4cddc52d00852660eab13dd0b4ae4",lineMID]
admin=['u3ad4cddc52d00852660eab13dd0b4ae4',lineMID]
...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย 🔝టู้ਫੇန้ণق✈Šäℽ•ℍⅈ🔝 ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ŚẾL₣ВΌŦ BY:
╔══════════════┓
╠ 🔝టู้ਫੇန้ণق✈Šäℽ•ℍⅈ🔝
╚══════════════┛""",
...
╔══════════════┓
╠★►Me ↔คอนแทค
╠★►Help2 ↔คำสั่งใช้ในกลุ่ม
╠★►Help3 ↔คำสั่งตั้งค่าเชลล์
╠★►Help4 ↔ คำสั่งโซเชียลมีเดีย
╠★►Help5 ↔ คำสั่งให้สิริพูด
╠★►Help6 ↔ คำสั่งแปลภาษา
╠★►บอทออน ↔ การใช้งานบอท
╠★►แทค ↔ แทคคนทั้งห้อง
╠★►ทีมบอท ↔ ผู้พัฒนาบอท
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u3ad4cddc52d00852660eab13dd0b4ae4"
                        creator = line.getContact(owner)
                        contact = line.getContact(lineMID)
                        grouplist = line.getGroupIdsJoined()
                        contactlist = line.getAllContactIds()
                        blockedlist = line.getBlockedContactIds()
                        ret_ = "╔══[ 🔝టู้ਫੇန้ণق✈Šäℽ•ℍⅈ🔝]"
...
#==============================================================================#
                    ...
                    line.sendContact(to, "u3ad4cddc52d00852660eab13dd0b4ae4")
                elif "ไวรัส" == msg.text.lower():
                    line.sendMessage(to, "หยุด ขอให้อยู่ในความสงบ")
                    line.sendContact(to, "phusui',")
                elif "ทีมบอท" == msg.text.lower():
                    msg.contentType = 13
                    line.sendMessage(to, "ADMIN \nŚẾL₣ВΌŦ (｡◕‿◕｡)")
                    line.sendContact(to, "u3ad4cddc52d00852660eab13dd0b4ae4")
                    line.sendContact(to, "uaacf01aabeb243ec46d5939945dbb319")
                    line.sendContact(to, "u88c1687e3034eac6ef4e8c0efd561123")                   
#==============================================================================#
